...
public class LibraryServer {
    ...
    public LibraryServer() {
        ...
        try {
            bookCollection = JsonUtil.readJsonFile(FILE_PATH, BookCollection.class);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void start() {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            ...
            while (true) {
                ...
                ClientHandler clientHandler = new ClientHandler(clientSocket, bookCollection, FILE_PATH);
